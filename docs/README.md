...
Single-page map of the project's docs. Keep this updated when you add or rename a doc.
...
## Design and data
- [system_diagram.md](system_diagram.md) — data flow Coinbase -> Kafka -> features -> API.
- [feature_spec.md](feature_spec.md) — feature definitions used by the model.
- [data_collection_log.md](data_collection_log.md) — what was captured when.
