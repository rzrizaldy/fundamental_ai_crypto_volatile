...
\hypersetup{
  pdftitle={Model Evaluation Report},
  pdfauthor={Rizaldy Utomo · rutomo@andrew.cmu.edu},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
positive rate distributed across all three splits (train 14 \%, val 37
\%, test 5.9 \%). The EDA tau sweep in \texttt{notebooks/eda.ipynb}
